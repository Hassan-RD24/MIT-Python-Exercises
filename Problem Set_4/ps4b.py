...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in range(len(lower_alphabet)):
            shifted_index = (i + shift) % len(lower_alphabet)
            shift_dict[lower_alphabet[i]] = lower_alphabet[shifted_index]
            shift_dict[upper_alphabet[i]] = upper_alphabet[shifted_index]
...
if __name__ == '__main__':
    ...
    print('Input: Hello, World!, shift = 4')
    ...
    print('Input: Lipps, Asvph!')
    print('Expected Output:', (22, 'Hello, World!'))
    print('Actual Output:', ciphertext1.decrypt_message())

    # Test case 2 (CiphertextMessage)
    ciphertext2 = CiphertextMessage('hfy')
    print('Input: hfy')
    print('Expected Output:', (21, 'cat'))
    print('Actual Output:', ciphertext2.decrypt_message())

    # TODO: best shift value and unencrypted story
    story = get_story_string()
    story_ciphertext = CiphertextMessage(story)
    best_shift, decrypted_story = story_ciphertext.decrypt_message()
    print('Best shift value for story.txt:', best_shift)
    print('Decrypted story:', decrypted_story)
